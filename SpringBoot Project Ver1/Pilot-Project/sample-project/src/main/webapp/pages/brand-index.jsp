...
<body>
	...
	<div class="container">
		<div class="sub-header">
			...
			<div class="float-right"><a class="btn btn-success add-btn" href="/sample-project/brand/add"><i class="fas fa-plus-square"></i> Add Brand</a></div>
		</div>
			...
			<tbody>
				<c:forEach var="brand" items="${brandsList}">
					<tr>
						...
						<td class="action-btns" data-id="${brand.brandId}"><a class="edit-btn" href="/sample-project/brand/update?id=${brand.brandId}"><i class="fas fa-edit"></i></a> | <a class="delete-btn" href="/sample-project/brand/delete?id=${brand.brandId}"><i class="fas fa-trash-alt"></i></a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
